...
4. Pin the extension by clicking the puzzle piece icon, then the thumbtack next to "Claude."
5. Grant the necessary permissions to enable Claude to interact with your browser.
