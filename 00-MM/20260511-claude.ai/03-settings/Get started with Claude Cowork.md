...
- aaa    **Deletion protection:** When using Cowork, Claude requires your explicit permission before permanently deleting any files. You will see a permission prompt and will need to select "Allow" before Claude is allowed to perform deletion tasks.
...
3. Type your instructions in the text box and click "Save":
	[![](https://downloads.intercomcdn.com/i/o/lupk8zyo/2180541860/aad5befe38e5d2da4f97040baa29/8c27842d-07d6-4b6f-b513-9ea9fbd002dc?expires=1778620500&signature=a124487c8ec4b416bd8aee99f42f98f733bd3adab80f792040d9f84005d7bffb&req=diEvFsx6nIlZWfMW1HO4zah%2FGLnjudx%2B8mPglonEgA6ZYy3xIpuN808bV2Wu%0ADeN9%0A)](https://downloads.intercomcdn.com/i/o/lupk8zyo/2180541860/aad5befe38e5d2da4f97040baa29/8c27842d-07d6-4b6f-b513-9ea9fbd002dc?expires=1778620500&signature=a124487c8ec4b416bd8aee99f42f98f733bd3adab80f792040d9f84005d7bffb&req=diEvFsx6nIlZWfMW1HO4zah%2FGLnjudx%2B8mPglonEgA6ZYy3xIpuN808bV2Wu%0ADeN9%0A)
...
- aaaa **Organize files:** "Organize my Downloads folder by type and date" — Claude can sort hundreds of files into categorized folders.
- **Process receipts:** Drop receipts in a folder and ask Claude to create a formatted expense report.
- aaaa **Batch rename:** Rename files with consistent patterns like YYYY-MM-DD formatting.

- aaaa **Research synthesis:** Combine information from web searches, articles, papers, and notes into coherent reports or summaries.
- aaa **Transcript analysis:** Extract themes, key points, and action items from meeting notes, interviews, or lecture recordings.
- aaaa **Personal knowledge synthesis:** Analyze your notes, journals, or research files to surface patterns, themes, and connections you might have missed.

- aa **Spreadsheets with formulas:** Generate Excel files with working VLOOKUP, conditional formatting, and multiple tabs—not just CSVs that need fixing.
- aa **Presentations:** Create slide decks from rough notes or meeting transcripts.
- aa **Reports from messy inputs:** Turn voice memos and scattered notes into polished documents.

- aa **Statistical analysis:** Outlier detection, cross-tabulation, and time-series analysis on your data files.
...
- aa **Code execution isolation:** Shell commands and code Claude writes run inside an isolated virtual machine (VM), separate from your main operating system.
- aa **Controlled file and network access:** Claude can only read and write files in folders you've connected, and network access follows the egress settings you've configured.
...
- aaaa   **Ask before acting:** Claude pauses so you can approve each action. This is recommended when you're working with new tools, unfamiliar files, or anything you want to watch closely.
...
aa In both modes, Claude will still ask before permanently deleting files. For more on when to use each mode, see **[Use Claude Cowork safely](https://support.claude.com/en/articles/13364135-use-claude-cowork-safely)**.
