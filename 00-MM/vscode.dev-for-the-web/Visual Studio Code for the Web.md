...
source: "https://code.visualstudio.com/docs/remote/vscode-web#_additional-browser-setup"
author:
  - "[[Microsoft]]"
...
When you're ready to switch, you'll be able to ["upgrade"](#_continue-working-in-a-different-environment) to the full VS Code experience with a few clicks.
...
![Type  in your browser and search a GitHub repository to open in vscode.dev](https://code.visualstudio.com/assets/docs/remote/vscode-web/chrome-omnibox-extension.png)
...
![GitHub Repositories](https://code.visualstudio.com/assets/docs/remote/vscode-web/remote-repositories.png)
...
| --- | --- | --- |
| GitHub | `/github/<org>/<repo>` | [More info above](#_github-repos) |
| Azure Repos | `/azurerepos/<org>/<project>/<repo>` | [More info above](#_azure-repos) |
| Visual Studio Live Share | `/editor/liveshare/<sessionId>` | [More info below](#_visual-studio-live-share) |
| Visual Studio Marketplace | `/editor/marketplace/<marketplacePublisher>`   `/<extensionId>/<extensionVersion>` | [Example route](https://insiders.vscode.dev/editor/marketplace/Brigit/devcontainer-image-convert/0.0.1) to edit [this extension](https://marketplace.visualstudio.com/items?itemName=Brigit.devcontainer-image-convert) |
| Power Pages | `/power/pages` | [Power Pages docs](https://learn.microsoft.com/power-pages/configure/visual-studio-code-editor) |
| Profiles | `/editor/profile/github/<GUID>` | [Profiles docs](https://code.visualstudio.com/docs/configure/profiles#_save-as-a-github-gist) |
| Themes | `/editor/theme/<extensionId>` | [More info below](#_themes) |
...
When working on a local file in the web, your work is saved automatically if you have [Auto Save](https://code.visualstudio.com/docs/editing/codebasics#_save--auto-save) enabled. You can also save manually as you do when working in desktop VS Code (for example **File** > **Save**).
...
You can also continue working in other environments via [Continue Working On](#_continue-working-in-a-different-environment).
...
![Language status indicator](https://code.visualstudio.com/assets/docs/remote/vscode-web/status-indicator.png)
...
![Limited extension support](https://code.visualstudio.com/assets/docs/remote/vscode-web/extension-limit.png)

Limited extension support

When you install an extension, it is saved in the browser's local storage. You can ensure your extensions are synced across VS Code instances, including different browsers and even the desktop, by enabling [Settings Sync](https://code.visualstudio.com/docs/configure/settings-sync).
...
![Python extension pack limit](https://code.visualstudio.com/assets/docs/remote/vscode-web/python-extension-limit.png)
...
There are additional steps you can take to improve your browser experience using VS Code for the Web. Review the [Additional browser setup](#_additional-browser-setup) section for more information.
...
| Ctrl+N for new file doesn't work in web. | Ctrl+N opens a new window instead.   As a workaround, you can use Ctrl+Alt+N (Cmd+Alt+N on macOS). |
| Ctrl+F4 for closing an editor doesn't work in web. | Ctrl+F4 closes the current tab in browsers.   As a workaround, you can use Ctrl+Shift+Alt+N (Cmd+Shift+Alt+N on macOS). |
...
![Allow clipboard access in the browser](https://code.visualstudio.com/assets/docs/remote/vscode-web/allow-clipboard-access.png)
